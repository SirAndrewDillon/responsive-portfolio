!(function (e, t) {
    ...
    function b(e, t, n, r, i) {
      ...
      for (f.textContent = "", d = 0; (o = p[d++]); )
        if (r && ge.inArray(o, r) > -1) i && i.push(o);
          ...
          ((l = ge.contains(o.ownerDocument, o)),
    ...
    function D(e, t) {
      ...
      if (1 === t.nodeType) {
        if (
          Pe.hasData(e) &&
          ((o = Pe.access(e)), (a = Pe.set(t, o)), (l = o.events))
        )
          for (i in (delete a.handle, (a.events = {}), l))
            for (n = 0, r = l[i].length; n < r; n++) ge.event.add(t, i, l[i][n]);
        Re.hasData(e) &&
          ((s = Re.access(e)), (u = ge.extend({}, s)), Re.set(t, u));
      }
    }
    function j(e, t) {
    ...
    function A(e, t, r, i) {
      ...
      var o,
        ...
        h = t[0],
        g = ge.isFunction(h);
      if (g || (p > 1 && "string" == typeof h && !de.checkClone && at.test(h)))
      ...
      if (
        ...
        for (u = (s = ge.map(y(o, "script"), S)).length; f < p; f++)
          (l = o),
            f !== d &&
              ((l = ge.clone(l, !0, !0)), u && ge.merge(s, y(l, "script"))),
            r.call(e[f], l, f);
        if (u)
          for (c = s[s.length - 1].ownerDocument, ge.map(s, N), f = 0; f < u; f++)
            (l = s[f]),
              Ge.test(l.type || "") &&
                !Pe.access(l, "globalEval") &&
                ge.contains(c, l) &&
                (l.src
                  ? ge._evalUrl && ge._evalUrl(l.src)
                  : n(l.textContent.replace(ut, ""), c));
      }
      return e;
    }
    function q(e, t, n) {
    ...
    function R(e, t, n, r, i) {
      ...
      for (
        ...
        "margin" === n && (a += ge.css(e, n + Be[o], !0, i)),
          r
            ? ("content" === n && (a -= ge.css(e, "padding" + Be[o], !0, i)),
              "margin" !== n &&
                (a -= ge.css(e, "border" + Be[o] + "Width", !0, i)))
            : ((a += ge.css(e, "padding" + Be[o], !0, i)),
              "padding" !== n &&
                (a += ge.css(e, "border" + Be[o] + "Width", !0, i)));
      return a;
    }
    ...
    function z(e, t, n) {
      ...
      if ((u = !ge.isEmptyObject(t)) || !ge.isEmptyObject(d))
        for (r in (f &&
          ...
          null == (l = v && v.display) && (l = Pe.get(e, "display")),
        ...
        d))
          u ||
            (v
              ...
              : (v = Pe.access(e, "fxshow", { display: l })),
            o && (v.hidden = !g),
            g && m([e], !0),
            p.done(function () {
              for (r in (g || m([e]), Pe.remove(e, "fxshow"), d))
                ge.style(e, r, d[r]);
            })),
            (u = _(g ? v[r] : 0, r, p)),
        ...
        if ((r = U.prefilters[o].call(l, e, c, l.opts)))
          return (
            ge.isFunction(r.stop) &&
              (ge._queueHooks(l.elem, l.opts.queue).stop = ge.proxy(r.stop, r)),
            r
          );
      return (
        ge.map(c, _, l),
        ge.isFunction(l.opts.start) && l.opts.start.call(e, l),
        l
        ...
        return (
          ...
          r(function (r, a, s, u) {
            var l,
              ...
              x = n ? (o || (r ? e : h || i) ? [] : a) : y;
            if ((n && n(y, x, s, u), i))
              for (l = m(x, d), i(l, [], s, u), c = l.length; c--; )
                (f = l[c]) && (x[d[c]] = !(y[d[c]] = f));
            if (r) {
              if (o || e) {
                if (o) {
      ...
      if (((n = n || Se), "string" == typeof e)) {
        ...
        if (r[1]) {
          if (
            ...
            ge.merge(
              this,
              ge.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : ne, !0)
            ),
        ...
        return (
          (i = ne.getElementById(r[2])) && ((this[0] = i), (this.length = 1)),
          this
        );
      }
      return e.nodeType
                  ...
                  return function () {
                        ...
                        : function () {
                            try {
                              ...
                              ge.Deferred.exceptionHook &&
                                ge.Deferred.exceptionHook(e, p.stackTrace),
                                t + 1 >= a &&
                                  (r !== l && ((s = void 0), (c = [e])),
                                  n.rejectWith(s, c));
                            }
                    ...
                    t
                      ...
                      : (ge.Deferred.getStackHook &&
                          (p.stackTrace = ge.Deferred.getStackHook()),
                        e.setTimeout(p));
                  };
                }
                var a = 0;
                return ge
                  .Deferred(function (e) {
                    n[0][3].add(o(0, e, ge.isFunction(i) ? i : u, e.notifyWith)),
                      ...
                      n[2][3].add(o(0, e, ge.isFunction(r) ? r : l));
                  })
                  .promise();
              },
              promise: function (e) {
      ...
      ge.extend({
        ...
        ready: function (e) {
          (!0 === e ? --ge.readyWait : ge.isReady) ||
            ((ge.isReady = !0),
            (!0 !== e && --ge.readyWait > 0) || He.resolveWith(ne, [ge]));
        },
      }),
      (ge.ready.then = He.then),
    ...
    (Ke = ne.createDocumentFragment().appendChild(ne.createElement("div"))),
      ...
      Ke.appendChild(Ze),
      (de.checkClone = Ke.cloneNode(!0).cloneNode(!0).lastChild.checked),
      (Ke.innerHTML = "<textarea>x</textarea>"),
      (de.noCloneChecked = !!Ke.cloneNode(!0).lastChild.defaultValue);
    ...
    (ge.event = {
        ...
        if (v)
          for (
            n.handler && ((n = (o = n).handler), (i = o.selector)),
              i && ge.find.matchesSelector(et, i),
      ...
      dispatch: function (e) {
        ...
        if (
          ...
          for (
            s = ge.event.handlers.call(this, t, l), n = 0;
            ...
            for (
              ...
              (t.rnamespace && !t.rnamespace.test(a.namespace)) ||
                ...
                void 0 !==
                  (i = (
                    (ge.event.special[a.origType] || {}).handle || a.handler
                  ).apply(o.elem, u)) &&
                  !1 === (t.result = i) &&
    ...
    ge.extend({
      ...
      ge.each(["height", "width"], function (e, t) {
        ge.cssHooks[t] = {
          get: function (e, n, r) {
            if (n)
              return !pt.test(ge.css(e, "display")) ||
    ...
    (ge.Animation = ge.extend(U, {
      ...
      (function () {
        var e = ne.createElement("input"),
          t,
          n = ne.createElement("select").appendChild(ne.createElement("option"));
        (e.type = "checkbox"),
          (de.checkOn = "" !== e.value),
          (de.optSelected = n.selected),
          ((e = ne.createElement("input")).value = "t"),
          (e.type = "radio"),
            ...
            return void 0 === e.getAttribute
              ...
              : ((1 === o && ge.isXMLDoc(e)) ||
                  (i =
                    ...
                    (ge.expr.match.bool.test(t) ? Tt : void 0)),
                void 0 !== n
                  ? null === n
        ...
        toggleClass: function (e, t) {
          ...
          return "boolean" == typeof t && "string" === n
            ...
            : this.each(function () {
                var t, r, i, o;
                if ("string" === n)
                  for (r = 0, i = ge(this), o = e.match(qe) || []; (t = o[r++]); )
    ...
    ge.extend(ge.event, {
      trigger: function (t, n, r, i) {
        ...
        if (
          ...
          3 !== r.nodeType &&
            8 !== r.nodeType &&
            !Nt.test(d + ge.event.triggered) &&
            (d.indexOf(".") > -1 &&
              ((h = d.split(".")), (d = h.shift()), h.sort()),
            (l = d.indexOf(":") < 0 && "on" + d),
            ((t = t[ge.expando]
              ? t
              : new ge.Event(d, "object" == typeof t && t)).isTrigger = i
              ? 2
              : 3),
            (t.namespace = h.join(".")),
          ...
          if (!i && !f.noBubble && !ge.isWindow(r)) {
            for (
              u = f.delegateType || d, Nt.test(u + d) || (a = a.parentNode);
              a;
              a = a.parentNode
            )
              p.push(a), (s = a);
        ...
        ajax: function (t, n) {
          ...
          h.hasContent
            ...
            : ((d = h.url.slice(o.length)),
              h.data && ((o += (At.test(o) ? "&" : "?") + h.data), delete h.data),
              !1 === h.cache &&
                ((o = o.replace(Rt, "$1")),
                (d = (At.test(o) ? "&" : "?") + "_=" + jt++ + d)),
              (h.url = o + d)),
    ...
    ge.ajaxSetup({
      ...
      (de.createHTMLDocument =
        (((Qt = ne.implementation.createHTMLDocument("").body).innerHTML =
          "<form></form><form></form>"),
      ...
      ge.each(["top", "left"], function (e, t) {
        ge.cssHooks[t] = H(de.pixelPosition, function (e, n) {
          if (n)
            return (n = L(e, t)), ct.test(n) ? ge(e).position()[t] + "px" : n;
        });
      }),
    ...
    return (
      (ge.noConflict = function (t) {
        return (
          e.$ === ge && (e.$ = Kt), t && e.jQuery === ge && (e.jQuery = Jt), ge
        );
      }),
      t || (e.jQuery = e.$ = ge),
      ge
